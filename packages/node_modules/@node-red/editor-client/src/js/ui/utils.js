...
RED.utils = (function() {
    ...
    function buildMessageSummaryValue(value) {
        ...
        if (Array.isArray(value)) {
            ...
            if (value.hasOwnProperty('type') && value.type === 'undefined') {
                ...
                result = $('<span class="red-ui-debug-msg-object-value red-ui-debug-msg-type-meta"></span>').text(value.subtype+'['+value.length+']');
    ...
    // The TypedArray types produced by the runtime encodeObject protocol.
    // This must be kept in sync with TYPED_ARRAY_NAMES in @node-red/util.
    const TYPED_ARRAY_TYPES = [
        'int8array','uint8array','uint8clampedarray',
        'int16array','uint16array','int32array','uint32array',
        'float32array','float64array','bigint64array','biguint64array'
    ];
    const TYPED_ARRAY_FORMAT_RE = new RegExp('^('+TYPED_ARRAY_TYPES.join('|')+')(\\[(\\d+)\\])?$');
    ...
    function createObjectElement(obj,options) {
        ...
        if (obj === null || obj === undefined) {
            ...
            if (isArrayObject) {
                ...
                type = (obj.type === 'typedarray') ? obj.subtype : obj.type.toLowerCase();
            } else if (/buffer/.test(typeHint)) {
                type = 'buffer';
            } else if (typeHint && TYPED_ARRAY_FORMAT_RE.test(typeHint)) {
                type = typeHint.replace(/\[\d+\]$/,'');
            }
    ...
    function decodeObject(payload,format) {
        if ((format === 'number') && (payload === "NaN")) {
            ...
            payload = -Infinity;
        } else if (format === 'Object' || /^(array|set|map)/.test(format) || TYPED_ARRAY_FORMAT_RE.test(format) || format === 'boolean' || format === 'number' ) {
